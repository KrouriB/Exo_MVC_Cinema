...
INSERT INTO `film` (`id_film`, `titre_film`, `date_sortie_film`, `temps_min_film`, `resume_film`, `note_film`, `image_film`, `id_realisateur`) VALUES
	(1, 'Star Wars IV', '1977-10-19', 121, NULL, NULL, 'indisponible.jpg', 1),
	(2, 'Star Wars V', '1980-08-20', 124, NULL, NULL, 'indisponible.jpg', 1),
	(3, 'Star Wars VI', '1983-10-19', 131, NULL, NULL, 'indisponible.jpg', 1),
	(4, 'Indiana Jones : Les Aventurier de l\'arche perdue', '1981-09-16', 115, NULL, NULL, 'indisponible.jpg', 1),
	(5, 'Blade Runner', '1982-09-15', 117, NULL, NULL, 'indisponible.jpg', 2),
	(6, 'Blade Runner 2049', '2017-10-04', 163, NULL, NULL, 'indisponible.jpg', 3),
	(7, 'Star Wars III', '2005-05-18', 140, NULL, NULL, 'indisponible.jpg', 1);
...
-- Listage des données de la table cinema.genrer : ~9 rows (environ)
